...
extern DWORD __stdcall _BigInB256(char *Data, DWORD Len, DWORD Big);
...
extern DWORD __stdcall _BigIn(char *string, DWORD base, DWORD big);

/* fills Big with Len bytes of data at Buffer in base Base (Base is 2-256)
	returns 0 if no error, -1 if base not supported */
extern DWORD __stdcall _BigInBytes(char *buffer, DWORD Len, DWORD base, DWORD Big);

/* fills Buffer with the value of Big in base 256
   returns the length of the string */
extern DWORD __stdcall _BigOutB256(DWORD Big, char *buffer);
...
extern DWORD __stdcall _BigOutB16(DWORD Big, char *buffer);

/* fills Buffer with the value of Big in base Base as a null-terminated string (Base is 2-62 or 256)
   returns the length of the string not including the terminating null character,
   -1 if base not supported*/
extern DWORD __stdcall _BigOut(DWORD big, DWORD base, char *buffer);
...
/* fills Buffer with the value of Big in base Base as data (Base is 2-256)
   ...
   -1 if base not supported */
extern DWORD __stdcall _BigOutBytes(DWORD Big, DWORD dtBase, char *buffer);

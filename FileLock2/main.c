...
void encrypt(char *filename, void *xtea)
{
	...
	/* Write XTEA key to the begin of file */
	WriteFile(hEncryptedFile,((XTEA_DATA *)xtea)->xtea_key, XTEA_KEY_SIZE, &dwBytesWritten, NULL);
...
void decrypt(char *filename, void *xtea)
{
	...
	/* Read XTEA key from beginning of file */
	ReadFile(hEncryptedFile, key, XTEA_KEY_SIZE, &dwBytesRead, NULL);
